...
public class EditImageFragment extends BottomSheetDialogFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    SeekBar seekBar_brightness, seekBar_constranst, seekBar_saturation;
    ...
    public static EditImageFragment getInstance(){
        if (instance==null) instance=new EditImageFragment();
        return instance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        seekBar_constranst = (SeekBar) itemView.findViewById(R.id.seekbar_constrast);
        seekBar_saturation = (SeekBar) itemView.findViewById(R.id.seekbar_saturation);

        seekBar_brightness.setMax(200);
        seekBar_brightness.setProgress(100);

        seekBar_constranst.setMax(20);
        seekBar_constranst.setProgress(0);

        seekBar_saturation.setMax(30);
        seekBar_saturation.setProgress(10);

        seekBar_saturation.setOnSeekBarChangeListener(this);
        seekBar_constranst.setOnSeekBarChangeListener(this);
